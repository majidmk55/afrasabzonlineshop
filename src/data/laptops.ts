...
export const LAPTOPS: Laptop[] = [
  ...
  },
  {
    ...
    specs: [
      CPU([
        ["مدل", "Qualcomm Snapdragon X Elite X1E-80-100"],
        ["هسته", "۱۲ هسته Oryon تا 3.4GHz"],
        ["واحد هوش مصنوعی", "NPU با ۴۵ تاپس (Copilot+)"],
        ["توان مصرفی", "بهینه برای مصرف کم — بدون فن پرصدا"],
      ]),
      GPU([
        ["مدل", "Qualcomm Adreno یکپارچه"],
        ["عملکرد", "3.8 ترافلاپس"],
        ["پشتیبانی", "DirectX 12 · رمزگشایی AV1"],
      ]),
      MEM([
        ["حافظه رم", "16GB LPDDR5x-8448 یکپارچه"],
        ["حافظه داخلی", "512GB NVMe SSD (قابل تعویض)"],
      ]),
      DISPLAY([
        ["اندازه و پنل", "13.8 اینچ PixelSense لمسی"],
        ["رزولوشن", "2304×1536 (201 PPI)"],
        ["نرخ نوسازی", "تا 120 هرتز تطبیقی"],
        ["پوشش رنگ", "sRGB + Vivid با Dolby Vision IQ"],
      ]),
      PORTS([
        ["پورت‌ها", "2× USB4 (USB-C) · 1× USB-A · Surface Connect · جک صدا"],
        ["بی‌سیم", "Wi-Fi 7 · Bluetooth 5.4"],
      ...
      BUILD([
        ["جنس بدنه", "آلومینیوم یکپارچه Platinum"],
        ["وزن", "1.34 کیلوگرم"],
        ["کیبورد", "بک‌لت با کلید اختصاصی Copilot"],
      ]),
      SOFT([
        ["سیستم‌عامل", "Windows 11 (Copilot+)"],
        ["هوش مصنوعی", "Recall · Live Captions · Studio Effects"],
  ...
  },
  {
    ...
    specs: [
      CPU([
        ["مدل", "Intel Core Ultra 5 125H"],
        ["هسته / رشته", "۱۴ هسته / ۱۸ رشته"],
        ["حداکثر فرکانس بوست", "4.5 گیگاهرتز"],
        ["واحد هوش مصنوعی", "Intel AI Boost NPU"],
      ]),
      GPU([
        ["مدل", "Intel Arc ۷ هسته‌ای"],
        ["پشتیبانی", "XeSS · AV1 · Ray Tracing سبک"],
      ]),
      MEM([
        ["حافظه رم", "16GB LPDDR5-6400 یکپارچه"],
        ["حافظه داخلی", "512GB NVMe PCIe Gen4"],
        ["اسلات M.2", "یک اسلات آزاد برای ارتقا"],
      ]),
      DISPLAY([
        ["اندازه و پنل", "14 اینچ OLED"],
        ["رزولوشن", "2880×1800 (2.8K)"],
        ["نرخ نوسازی", "90 هرتز"],
        ["پوشش رنگ", "100% DCI-P3 · VESA HDR True Black 500"],
      ]),
      PORTS([
        ["پورت‌ها", "2× Thunderbolt 4 · 2× USB-A 3.2 · HDMI 2.1 · microSD · جک صدا"],
        ["بی‌سیم", "Wi-Fi 6E · Bluetooth 5.3"],
        ["وب‌کم", "1440p با شاتر حریم خصوصی"],
      ]),
      BATTERY([
        ["ظرفیت", "65Wh"],
      ...
      BUILD([
        ["جنس بدنه", "آلومینیوم با استاندارد نظامی MIL-STD 810H"],
        ["وزن", "1.32 کیلوگرم"],
        ["کیبورد", "بک‌لت با حسگر اثر انگشت"],
      ]),
      SOFT([
        ["سیستم‌عامل", "Windows 11 Home"],
