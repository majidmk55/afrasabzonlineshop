...
const BOT_RESPONSES: Record<string, string> = {
  "شرایط گارانتی": "تمامی لپ‌تاپ‌های افرالیک دارای ۲ سال گارانتی رسمی هستند. علاوه بر این، پوشش ۲ ساله افرالیک نیز شامل بدنه، لولا و باتری می‌شود. برای اطلاعات بیشتر با شماره ۰۲۱-۹۱۰۰۴۸۲۰ تماس بگیرید.",
...
export default function LiveChat() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      text: "سلام! 👋 به افرالیک خوش آمدید. چطور می‌توانم کمکتان کنم؟",
      sender: "bot",
      timestamp: new Date(),
    },
  ]);
        ...
        <div className="fixed bottom-24 left-6 z-50 flex h-[500px] w-[380px] flex-col overflow-hidden rounded-2xl border border-line bg-white shadow-2xl">
          ...
          <div className="bg-sea p-4 text-white">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-bold">پشتیبانی افرالیک</h3>
