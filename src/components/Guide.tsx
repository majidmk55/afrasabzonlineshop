...
export default function Guide() {
  return (
    <>
      {/* استاندارد افرالینک — sticky two-column */}
      <section className="dark-panel relative overflow-hidden" aria-label="استاندارد افرالینک">
          ...
          <div className="lg:sticky lg:top-28 lg:self-start">
            <Reveal>
              ...
              <h2 className="mt-3 font-display text-5xl leading-[1.15] text-white sm:text-6xl">
                استانداردِ
                <br />
                افرالینک<span className="text-sea">.</span>
              </h2>
