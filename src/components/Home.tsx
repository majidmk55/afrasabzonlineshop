...
export default function Home({ products, onBrand, onCategory, onPrice, onExplore, onSpecs }: HomeProps) {
  ...
  if (products.length === 0) {
    return (
      <section className="mx-auto max-w-[95%] px-1 py-24 text-center sm:px-2">
  ...
  return (
    <>
      ...
      <section className="relative w-full overflow-hidden bg-deeplit" aria-label="بیلبورد اصلی">
        ...
        <div className="relative mx-auto flex min-h-[280px] max-w-[95%] flex-col justify-center px-1 py-10 sm:min-h-[340px] sm:px-2 lg:min-h-[400px]">
      ...
      <section className="mx-auto max-w-[95%] px-1 pt-14 sm:px-2" aria-label="خرید بر اساس کاربرد">
        <Reveal>
      ...
      {/* ── خرید بر اساس بودجه ── */}
      <section className="mx-auto max-w-[95%] px-1 py-14 sm:px-2" aria-label="خرید بر اساس بودجه">
        <Reveal>
          <div className="flex items-center gap-4">
