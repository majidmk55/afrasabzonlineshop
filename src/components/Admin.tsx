  ...
  const submit = () => {
    ...
    const p: Laptop = {
      ...
      specs: initial?.specs ?? [
        ...
        { title: "پردازنده", icon: "cpu", rows: [["مدل", dash(f.cpu)], ["تعداد هسته", "—"], ["تعداد رشته", "—"], ["حداکثر فرکانس بوست", "—"]] },
        ...
        { title: "گرافیک", icon: "gpu", rows: [["مدل گرافیک مجزا", dash(f.gpu)], ["سطح فناوری ساخت تراشه", "—"], ["معماری", "—"], ["حافظه گرافیک مجزا", "—"], ["نوع حافظه گرافیک", "—"], ["تعداد هسته‌های اصلی", "—"], ["فرکانس پایه", "—"], ["توان مصرفی", "—"], ["باس حافظه", "—"], ["پهنای باند حافظه", "—"], ["تعداد هسته‌های RT", "—"], ["تعداد هسته‌های تنسور", "—"], ["تعداد هسته‌های پردازش AI", "—"], ["سرعت پردازش AI", "—"], ["فناوری‌ها", "—"]] },
    ...
    for (const line of text.split("\n")) {
      ...
      ok.push({
        ...
        specs: [
          ...
          { title: "پردازنده", icon: "cpu", rows: [["مدل", "به‌زودی"]] },
          { title: "حافظه رم", icon: "ram", rows: [["حافظه داخلی رم", "به‌زودی"]] },
          { title: "ذخیره‌سازی", icon: "drive", rows: [["ظرفیت کل ذخیره‌سازی", "به‌زودی"]] },
          { title: "گرافیک", icon: "gpu", rows: [["مدل گرافیک مجزا", "به‌زودی"], ["سطح فناوری ساخت تراشه", "—"], ["معماری", "—"], ["حافظه گرافیک مجزا", "—"], ["نوع حافظه گرافیک", "—"], ["تعداد هسته‌های اصلی", "—"], ["فرکانس پایه", "—"], ["توان مصرفی", "—"], ["باس حافظه", "—"], ["پهنای باند حافظه", "—"], ["تعداد هسته‌های RT", "—"], ["تعداد هسته‌های تنسور", "—"], ["تعداد هسته‌های پردازش AI", "—"], ["سرعت پردازش AI", "—"], ["فناوری‌ها", "—"]] },
